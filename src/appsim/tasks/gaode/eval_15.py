#!/usr/bin/env python3
"""
Android App Bus Navigation Log Verification Script

This script verifies that the "公交导航去木屋烧烤" action was correctly recorded
...
def verify_last_log15(result=None, device_id=None):
    """
    Verify the last log entry in 15_muyu_navigation_history.json matches the expected action.
    ...
    try:
        ...
        cmd.extend(["exec-out", "run-as", "com.example.GaoDe", "cat", "files/15_muyu_navigation_history.json"])
        ...
        expected_action = "公交导航去木屋烧烤"
        actual_action = last_record["action"]
        if actual_action == expected_action:
            print("PASS: Bus navigation to Muyu BBQ verification successful")
...
if __name__ == "__main__":
    # Verify the expected operation: "公交导航去木屋烧烤"
    success = verify_last_log15()
