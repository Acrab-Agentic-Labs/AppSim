...
def verify_last_log14(result=None, device_id=None):
    """
    ...
    try:
        ...
        cmd.extend(["exec-out", "run-as", "com.example.GaoDe", "cat", "files/14_hotel_share_history.json"])
