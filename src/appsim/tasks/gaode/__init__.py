...
GAODE_TASKS = AppTasks(
    ...
    task_items=[
        TaskItem(
            instruction="我想看看有新消息吗",
            verify_func=verify_last_navigation_log1,
            human_steps=2,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="我想去我收藏过的地点，请帮我选择一个",
            verify_func=verify_last_log2,
            human_steps=2,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="搜搜附近的美食",
            verify_func=verify_last_log3,
            human_steps=2,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="去和妈妈聊天",
            verify_func=verify_last_log6,
            human_steps=2,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="我要导航回家",
            verify_func=verify_last_log7,
            human_steps=4,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="想吃巴奴火锅，搜一搜在哪",
            verify_func=verify_last_log8,
            human_steps=3,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="打车去东湖风景区",
            verify_func=verify_last_log9,
            human_steps=6,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="预订汉庭酒店",
            verify_func=verify_last_log10,
            human_steps=3,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="觉得老乡鸡不错，收藏这家餐厅",
            verify_func=verify_last_log11,
            human_steps=5,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="想跟爸爸聊两句，发起和爸爸的聊天",
            verify_func=verify_last_log12,
            human_steps=4,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="分享如家酒店位置给妈妈",
            verify_func=verify_last_log14,
            human_steps=6,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="数一下我的订单数量",
            verify_func=eval_21,
            human_steps=2,
            is_reasoning=True,
        ),
        TaskItem(
            instruction="数一下我和妈妈的聊天记录条数",
            verify_func=eval_22,
            human_steps=3,
            is_reasoning=True,
        ),
        TaskItem(
            instruction="告诉我口碑最好的餐厅",
            verify_func=eval_23,
            human_steps=3,
            is_reasoning=True,
        ),
        TaskItem(
            instruction="正在营业的餐厅有几家",
            verify_func=eval_24,
            human_steps=3,
            is_reasoning=True,
        ),
        TaskItem(
            instruction="告诉我用时最短的景点",
            verify_func=eval_25,
            human_steps=3,
            is_reasoning=True,
        ),
        TaskItem(
            instruction="告诉我距离老象峰景区最近的机场",
            verify_func=eval_26,
            human_steps=1,
            is_reasoning=True,
        ),
        TaskItem(
            instruction="告诉我从我的位置途径如家酒店再到麦当劳用时最短的出行方式",
            verify_func=eval_27,
            human_steps=10,
            is_reasoning=True,
        ),
        TaskItem(
            instruction="告诉我到金雁酒店最优惠的优享型车名",
            verify_func=eval_28,
            human_steps=7,
            is_reasoning=True,
        ),
