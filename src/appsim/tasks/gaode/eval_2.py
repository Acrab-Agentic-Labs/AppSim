...
def verify_last_log2(result=None, device_id=None):
    """
    ...
    try:
        ...
        cmd.extend(["exec-out", "run-as", "com.example.GaoDe", "cat", "files/2_favorites_history.json"])
