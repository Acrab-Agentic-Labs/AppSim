...
def verify_store_chat_muted(result=None, device_id=None, backup_dir=None):
    ...
    cmd.extend(["exec-out", "run-as", "com.example.jd_sim", "cat", "files/persistent_data/mute_settings.json"])
    ...
    for setting in settings:
        if isinstance(setting, dict):
            ...
            if sender_name == "Apple官方旗舰店" and is_muted:
                return True
