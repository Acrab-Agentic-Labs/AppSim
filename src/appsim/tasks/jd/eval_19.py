...
def verify_default_address_created(result=None, device_id=None, backup_dir=None):
    ...
    for address in addresses:
        if isinstance(address, dict):
            ...
            if (
                recipient_name == "代嘉仪"
                and phone_number == "13066666666"
                and province == "湖北省"
                and city == "武汉市"
                and district == "江夏区"
                and "文秀街9号" in detail_address
                and is_default
            ):
                return True
...
if __name__ == "__main__":
    result = verify_default_address_created()
    print(result)
