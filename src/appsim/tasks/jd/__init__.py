...
JD_TASKS = AppTasks(
    ...
    task_items=[
        ...
        TaskItem(
            instruction="算一下首页前十个商品中，评分大于等于4.7的有几个，给出一个阿拉伯数字即可。",
            verify_func=validate_task_thirteen,
            human_steps=3,
            is_reasoning=True,
        ),
        TaskItem(
            instruction="查看首页iPhone15商品共有多少条评论,给出一个阿拉伯数字即可。",
        ...
        TaskItem(
            instruction="搜索iPhone15并筛选出价格在6000.0至8000.0的手机类别商品有多少个，给出一个阿拉伯数字即可。",
