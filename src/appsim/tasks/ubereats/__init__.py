...
from .eval_7 import TASK7_ANSWER_SCHEMA, validate_task_seven
...
from .eval_11 import TASK11_ANSWER_SCHEMA, validate_task_eleven
from .eval_12 import TASK12_ANSWER_SCHEMA, validate_task_twelve
from .eval_13 import TASK13_ANSWER_SCHEMA, validate_task_thirteen
from .eval_14 import TASK14_ANSWER_SCHEMA, validate_task_fourteen
from .eval_15 import TASK15_ANSWER_SCHEMA, validate_task_fifteen
from .eval_16 import TASK16_ANSWER_SCHEMA, validate_task_sixteen
from .eval_17 import TASK17_ANSWER_SCHEMA, validate_task_seventeen
from .eval_18 import TASK18_ANSWER_SCHEMA, validate_task_eighteen
from .eval_19 import TASK19_ANSWER_SCHEMA, validate_task_nineteen
from .eval_20 import TASK20_ANSWER_SCHEMA, validate_task_twenty
from .eval_21 import TASK21_ANSWER_SCHEMA, validate_task_twenty_one
from .eval_22 import validate_task_twenty_two
from .eval_23 import validate_task_twenty_three
from .eval_24 import TASK24_ANSWER_SCHEMA, validate_task_twenty_four
