...
def verify_post_published_with_like_count_hidden_and_facebook_sharing(adb, ui):
...
if __name__ == "__main__":
    run_check(verify_post_published_with_like_count_hidden_and_facebook_sharing)
