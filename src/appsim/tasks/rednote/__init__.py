...
RED_NOTE_TASKS = AppTasks(
    ...
    task_items=[
        TaskItem(
            ...
            verify_func=MessageSendCheck,
            human_steps=5,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="总结首页前3篇笔记内容",
            verify_func=BrowseNotesCheck,
            human_steps=6,
            is_reasoning=False,
        ),
        TaskItem(
            instruction='搜索"秋冬穿搭"，总结搜索结果前3条内容详情',
            verify_func=SearchAndViewCheck,
            human_steps=11,
            is_reasoning=False,
        ),
        TaskItem(
        ...
        TaskItem(
            ...
            verify_func=FollowAuthorCheck,
            human_steps=2,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="查看评论和@你的消息，回复最新收到的一条评论，内容为'谢谢喜欢～'",
            verify_func=ReplyCommentCheck,
            human_steps=6,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="总结你关注的第一个博主的第一条笔记",
            verify_func=BrowsingHistoryCheck,
            human_steps=5,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="对首页第二篇笔记选择'不喜欢'。",
            verify_func=DislikeNoteCheck,
            human_steps=4,
            is_reasoning=False,
        ),
        TaskItem(
        ...
        TaskItem(
            ...
            verify_func=SetPasswordCheck,
            human_steps=9,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="将自己的名字修改为'111'",
            verify_func=ChangeNicknameCheck,
            human_steps=5,
            is_reasoning=False,
        ),
        TaskItem(
        ...
        TaskItem(
            ...
            verify_func=SendMessageCheck,
            human_steps=7,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="查看首页第二篇笔记的第一条评论，对评论进行点赞",
            verify_func=LikeCommentCheck,
            human_steps=3,
            is_reasoning=False,
        ),
        TaskItem(
        ...
        TaskItem(
            ...
            verify_func=SearchResultCountCheck,
            human_steps=4,
            is_reasoning=False,
        ),
        TaskItem(
        ...
        TaskItem(
            ...
            verify_func=NoteInteractionCheck,
            human_steps=8,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="对'我'的第一个粉丝进行'回关'",
            verify_func=FollowBackFanCheck,
            human_steps=3,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="浏览我'赞过'的前3条笔记，并评论'很有用'",
            verify_func=ViewAndCommentNotesCheck,
            human_steps=13,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="统计博主'旅行日记'发布笔记数量",
            verify_func=CountAuthorNotesCheck,
            human_steps=4,
            is_reasoning=True,
        ),
        TaskItem(
            instruction="对'潮流时尚达人'取消关注",
            verify_func=UnfollowAuthorCheck,
            human_steps=3,
            is_reasoning=False,
        ),
        TaskItem(
