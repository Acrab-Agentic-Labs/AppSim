...
def verify_book_most_expensive_london_stay_day_after_tomorrow(
    ...
    **kwargs,
    ...
    """
    Task 3: Book the most expensive London stay for the day after tomorrow.

    Verification logic:
    - Find the latest order for hotel htl001 (most expensive London hotel)
    - Order type must be STAY
    - Order status must be ACTIVE
    - Start date must match the day after tomorrow
    """
    task_id = 3
