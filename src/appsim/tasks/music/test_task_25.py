...
from .verification_functions import task_25_check_invite_friend


def test25(result=None, device_id=None):
    result1 = task_25_check_invite_friend(device_id=device_id, result=result)
