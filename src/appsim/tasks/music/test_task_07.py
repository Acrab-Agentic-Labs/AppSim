...
def check_shuffle_mode_enabled(result=None, device_id=None, backup_dir=None):
    """
    任务7: 验证是否切换到随机播放模式
...
if __name__ == "__main__":
    ...
    print("\n📋 人工操作步骤：")
    print("  1. 进入播放页面")
    print("  2. 点击播放模式切换按钮，直到显示为随机播放")
    print("\n🔍 开始验证...")

    success = check_shuffle_mode_enabled()

    print(f"\n任务7验证结果: {'成功' if success else '失败'}")
