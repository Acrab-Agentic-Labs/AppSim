...
def test21(playlist_id=None, expected_count=None, result=None, device_id=None):
    ...
    result1 = task_21_check_delete_song_from_playlist(playlist_id, expected_count, device_id=device_id, result=result)
