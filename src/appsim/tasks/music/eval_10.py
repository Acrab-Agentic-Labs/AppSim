...
def verify_search_playback_favorite_lyrics_next_shuffle(result=None, device_id=None, backup_dir=None):
    """
    任务10: 验证复合操作
    1. 搜索历史包含"丑八怪"
    2. 歌曲被收藏
...
if __name__ == "__main__":
    print(verify_search_playback_favorite_lyrics_next_shuffle())
