...
def verify_first_song_deleted_from_playlist(result=None, device_id=None, backup_dir=None):
    """
    任务3: 验证是否从热歌榜删除歌曲
    - 动态查找'热歌榜'的ID
...
if __name__ == "__main__":
    ...
    print(verify_first_song_deleted_from_playlist(result=mock_result))
