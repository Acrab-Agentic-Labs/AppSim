...
def verify_profile_page_opened(result=None, device_id=None, backup_dir=None):
    ...
    try:
        ...
        return latest_event["icon"] == "我的" and latest_event["page"] == "我的页面"
    except:
        return False


if __name__ == "__main__":
    print("true" if verify_profile_page_opened() else "false")
