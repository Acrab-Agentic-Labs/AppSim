...
def verify_first_hotel_room_booking_created(result=None, device_id=None, backup_dir=None):
...
if __name__ == "__main__":
    print("true" if verify_first_hotel_room_booking_created() else "false")
