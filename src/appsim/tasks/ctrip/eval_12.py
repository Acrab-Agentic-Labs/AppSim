...
def verify_flight_search_results_for_requested_cabin(result=None, device_id=None, backup_dir=None):
...
if __name__ == "__main__":
    print("true" if verify_flight_search_results_for_requested_cabin() else "false")
