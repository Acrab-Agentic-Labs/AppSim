...
def verify_train_search_results_for_requested_date(result=None, device_id=None, backup_dir=None):
    ...
    try:
        ...
        return latest_event.get("type") == "train_search" and latest_event.get("date") == "2025-10-24"
    except:
        return False


if __name__ == "__main__":
    print("true" if verify_train_search_results_for_requested_date() else "false")
