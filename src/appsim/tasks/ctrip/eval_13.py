...
def verify_train_search_results_for_requested_route(result=None, device_id=None, backup_dir=None):
...
if __name__ == "__main__":
    print("true" if verify_train_search_results_for_requested_route() else "false")
