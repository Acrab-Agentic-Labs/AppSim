...
def verify_message_list_opened(result=None, device_id=None, backup_dir=None):
    ...
    try:
        ...
        return latest_event["icon"] == "消息" and latest_event["page"] == "消息页面"
    except:
        return False


if __name__ == "__main__":
    print("true" if verify_message_list_opened() else "false")
