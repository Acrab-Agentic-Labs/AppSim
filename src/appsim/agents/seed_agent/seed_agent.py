...
class SeedAgent(BaseAgent):
    ...
    def execute_instruction(self, instruction, max_steps=50, max_attempts_per_step=3) -> AgentExecutionResult:
        ...
        return AgentExecutionResult(
            success=False,  # 只有收到 finished 动作才算成功；走到这里说明任务未完成
    ...
    def open_app(self, app_name):
        ...
        try:
            # 常用应用包名映射
            common_apps = {
                "Amazon": APP_TASKS_MAP[AppEnum.AMAZON].package_name,
                "amazon": APP_TASKS_MAP[AppEnum.AMAZON].package_name,
                "AMAZON": APP_TASKS_MAP[AppEnum.AMAZON].package_name,
                "Booking": APP_TASKS_MAP[AppEnum.BOOKING].package_name,
                "booking": APP_TASKS_MAP[AppEnum.BOOKING].package_name,
                "BOOKING": APP_TASKS_MAP[AppEnum.BOOKING].package_name,
                "B站": APP_TASKS_MAP[AppEnum.BILIBILI].package_name,
                "b站": APP_TASKS_MAP[AppEnum.BILIBILI].package_name,
                "哔哩哔哩": APP_TASKS_MAP[AppEnum.BILIBILI].package_name,
                "Bilibili": APP_TASKS_MAP[AppEnum.BILIBILI].package_name,
                "bilibili": APP_TASKS_MAP[AppEnum.BILIBILI].package_name,
                "BILIBILI": APP_TASKS_MAP[AppEnum.BILIBILI].package_name,
                "携程旅行": APP_TASKS_MAP[AppEnum.CTRIP].package_name,
                "携程": APP_TASKS_MAP[AppEnum.CTRIP].package_name,
                "Ctrip": APP_TASKS_MAP[AppEnum.CTRIP].package_name,
                "ctrip": APP_TASKS_MAP[AppEnum.CTRIP].package_name,
                "CTRIP": APP_TASKS_MAP[AppEnum.CTRIP].package_name,
                "饿了么": APP_TASKS_MAP[AppEnum.ELEME].package_name,
                "EleMe": APP_TASKS_MAP[AppEnum.ELEME].package_name,
                "eleme": APP_TASKS_MAP[AppEnum.ELEME].package_name,
                "ELEME": APP_TASKS_MAP[AppEnum.ELEME].package_name,
                "高德地图": APP_TASKS_MAP[AppEnum.GAODE].package_name,
                "高德": APP_TASKS_MAP[AppEnum.GAODE].package_name,
                "Gaode": APP_TASKS_MAP[AppEnum.GAODE].package_name,
                "gaode": APP_TASKS_MAP[AppEnum.GAODE].package_name,
                "GAODE": APP_TASKS_MAP[AppEnum.GAODE].package_name,
                "AMap": APP_TASKS_MAP[AppEnum.GAODE].package_name,
                "amap": APP_TASKS_MAP[AppEnum.GAODE].package_name,
                "Instagram": APP_TASKS_MAP[AppEnum.INSTAGRAM].package_name,
                "instagram": APP_TASKS_MAP[AppEnum.INSTAGRAM].package_name,
                "INSTAGRAM": APP_TASKS_MAP[AppEnum.INSTAGRAM].package_name,
                "IG": APP_TASKS_MAP[AppEnum.INSTAGRAM].package_name,
                "ig": APP_TASKS_MAP[AppEnum.INSTAGRAM].package_name,
                "京东": APP_TASKS_MAP[AppEnum.MYJD].package_name,
                "京东商城": APP_TASKS_MAP[AppEnum.MYJD].package_name,
                "MyJD": APP_TASKS_MAP[AppEnum.MYJD].package_name,
                "myjd": APP_TASKS_MAP[AppEnum.MYJD].package_name,
                "MYJD": APP_TASKS_MAP[AppEnum.MYJD].package_name,
                "JD": APP_TASKS_MAP[AppEnum.MYJD].package_name,
                "jd": APP_TASKS_MAP[AppEnum.MYJD].package_name,
                "网易云音乐": APP_TASKS_MAP[AppEnum.MUSIC].package_name,
                "网易云": APP_TASKS_MAP[AppEnum.MUSIC].package_name,
                "云音乐": APP_TASKS_MAP[AppEnum.MUSIC].package_name,
                "音乐": APP_TASKS_MAP[AppEnum.MUSIC].package_name,
                "Music": APP_TASKS_MAP[AppEnum.MUSIC].package_name,
                "music": APP_TASKS_MAP[AppEnum.MUSIC].package_name,
                "MUSIC": APP_TASKS_MAP[AppEnum.MUSIC].package_name,
                "NetEase Cloud Music": APP_TASKS_MAP[AppEnum.MUSIC].package_name,
                "netease cloud music": APP_TASKS_MAP[AppEnum.MUSIC].package_name,
                "小红书": APP_TASKS_MAP[AppEnum.RED_NOTE].package_name,
                "红书": APP_TASKS_MAP[AppEnum.RED_NOTE].package_name,
                "RedNote": APP_TASKS_MAP[AppEnum.RED_NOTE].package_name,
                "rednote": APP_TASKS_MAP[AppEnum.RED_NOTE].package_name,
                "Red Note": APP_TASKS_MAP[AppEnum.RED_NOTE].package_name,
                "red note": APP_TASKS_MAP[AppEnum.RED_NOTE].package_name,
                "RED_NOTE": APP_TASKS_MAP[AppEnum.RED_NOTE].package_name,
                "Spotify": APP_TASKS_MAP[AppEnum.SPOTIFY].package_name,
                "spotify": APP_TASKS_MAP[AppEnum.SPOTIFY].package_name,
                "SPOTIFY": APP_TASKS_MAP[AppEnum.SPOTIFY].package_name,
                "腾讯会议": APP_TASKS_MAP[AppEnum.TENCENT_MEETING].package_name,
                "TencentMeeting": APP_TASKS_MAP[AppEnum.TENCENT_MEETING].package_name,
                "tencentmeeting": APP_TASKS_MAP[AppEnum.TENCENT_MEETING].package_name,
                "Tencent Meeting": APP_TASKS_MAP[AppEnum.TENCENT_MEETING].package_name,
                "tencent meeting": APP_TASKS_MAP[AppEnum.TENCENT_MEETING].package_name,
                "TENCENT_MEETING": APP_TASKS_MAP[AppEnum.TENCENT_MEETING].package_name,
                "UberEats": APP_TASKS_MAP[AppEnum.UBEREATS].package_name,
                "ubereats": APP_TASKS_MAP[AppEnum.UBEREATS].package_name,
                "Uber Eats": APP_TASKS_MAP[AppEnum.UBEREATS].package_name,
                "uber eats": APP_TASKS_MAP[AppEnum.UBEREATS].package_name,
                "UBEREATS": APP_TASKS_MAP[AppEnum.UBEREATS].package_name,
                "微信": APP_TASKS_MAP[AppEnum.WECHAT].package_name,
                "WeChat": APP_TASKS_MAP[AppEnum.WECHAT].package_name,
                "wechat": APP_TASKS_MAP[AppEnum.WECHAT].package_name,
                "WECHAT": APP_TASKS_MAP[AppEnum.WECHAT].package_name,
                "WhatsApp": APP_TASKS_MAP[AppEnum.WHATSAPP].package_name,
                "Whatsapp": APP_TASKS_MAP[AppEnum.WHATSAPP].package_name,
                "whatsapp": APP_TASKS_MAP[AppEnum.WHATSAPP].package_name,
                "WHATSAPP": APP_TASKS_MAP[AppEnum.WHATSAPP].package_name,
                "YouTube": APP_TASKS_MAP[AppEnum.YOUTUBE].package_name,
                "Youtube": APP_TASKS_MAP[AppEnum.YOUTUBE].package_name,
                "youtube": APP_TASKS_MAP[AppEnum.YOUTUBE].package_name,
                "YOUTUBE": APP_TASKS_MAP[AppEnum.YOUTUBE].package_name,
                "Zoom": APP_TASKS_MAP[AppEnum.ZOOM].package_name,
                "zoom": APP_TASKS_MAP[AppEnum.ZOOM].package_name,
                "ZOOM": APP_TASKS_MAP[AppEnum.ZOOM].package_name,
            }
