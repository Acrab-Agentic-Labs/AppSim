...
class BaselineEnum(Enum):
    ...
    CLAUDE47_OPUS = "Claude-4.7-Opus"
    CLAUDE46_SONNET = "Claude-4.6-Sonnet"
    CLAUDE45_HAIKU = "Claude-4.5-Haiku"
    CLAUDE45_SONNET = "Claude-4.5-Sonnet"  # 论文和代码都有

    # Gemini 系列 (使用 m3a_agent) - 论文中有3个
    GEMINI3_PRO = "Gemini-3-Pro"
    GEMINI25_PRO = "Gemini-2.5-Pro"  # 论文和代码都有
...
def create_agent(
    ...
    # 论文中的 Qwen 系列模型
        ...
        base_url = os.getenv("QWEN36_PLUS_API_BASE", base_url)
        model_name = os.getenv("QWEN36_PLUS_MODEL_NAME", model_name)
        model_kwargs = {}
        ...
        base_url = os.getenv("QWEN36_FLASH_API_BASE", base_url)
        model_name = os.getenv("QWEN36_FLASH_MODEL_NAME", model_name)
        model_kwargs = {}
